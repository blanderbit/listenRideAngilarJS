...
angular.module('listnride').factory('price', ['$translate', 'date',
  function($translate, date) {
    return {
      ...
      calculatePrices: function (startDate, endDate, prices, coverageTotal, isPremiumCoverage, isShopUser, includeVAT) {
        var result = {
          subtotal: 0,
        ...
        if (!isShopUser) {
          ...
          result.serviceFee += includeVAT ? result.subtotalDiscounted * VAT_TAX : 0;
        }
